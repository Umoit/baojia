  ...
  <div class="panel panel-default">
    ...
    <div class="row wrapper">
      ...
      <div class="col-sm-5 m-b-xs">
        ...
        <div class="col-md-3">
          <select class="input-sm form-control w-sm inline v-middlec">
            @foreach($countries as $country)
              <option name="country" value="{{$country->id}}">{{$country->code}}_{{$country->name}}</option>
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        <div class="col-sm-3 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">showing {{$offers->firstItem()}}-{{$offers->lastItem()}} of {{$offers->total()}} items</small>
        </div>
